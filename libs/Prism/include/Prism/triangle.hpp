 ...
 * This class inherits from Object and implements the hit method to check for ray-triangle intersections.
 * It is used to represent a triangle in a 3D scene, allowing for ray tracing and collision detection.
 */
...
public:
     ...
     * This constructor initializes the triangle with the specified vertices and material properties.
     */
     ...
     * @return True if the ray intersects the triangle within the specified distance range, false otherwise.
     * This method transforms the ray using the inverse transformation matrix of the triangle and checks for intersection.
     * If a hit is found, it updates the hit record with the intersection point, normal, and material properties.
     */
    virtual
...
private:
    ...
    std::shared_ptr<Material> material; ///< Material properties of the triangle, defining how it interacts with light
};

/**
 * @class MeshTriangle
 * @brief Represents a triangle in a mesh, defined by three points.
 * This class is used to represent a triangle in a 3D mesh, allowing for ray tracing and collision detection.
 * It can be constructed from shared pointers to Point3 objects or directly from Point3 objects.
 */
...
public:
     ...
     * @param points An initializer list containing three Point3 objects representing the vertices of the triangle.
     * This constructor initializes the MeshTriangle with the specified points.
     */
     ...
     * @param rec The HitRecord to be filled upon a collision.
     * @return True if the ray intersects the triangle within the specified distance range, false otherwise.
     * This method checks for intersection between the ray and the triangle defined by the three points.
     * If a hit is found, it updates the hit record with the intersection point, normal, and other relevant details.
     */
