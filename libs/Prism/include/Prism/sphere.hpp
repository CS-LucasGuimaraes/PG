 ...
 * This class inherits from Object and implements the hit method to check for ray-sphere intersections.
 */
class PRISM_EXPORT Sphere : public Object {
  public:
     ...
     * This constructor initializes the sphere with the specified center, radius, and material properties.
     */
     ...
     * @return True if the ray intersects the sphere within the specified distance range, false otherwise.
     * This method transforms the ray using the inverse transformation matrix of the sphere and checks for intersection.
  ...
  private:
    ...
    std::shared_ptr<Material> material; ///< Material properties of the sphere, defining how it interacts with light
};
