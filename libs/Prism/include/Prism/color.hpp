...
namespace Prism {
     ...
     *  Each component is a double value ranging from 0.0 to 1.0, representing the intensity of the color.
     *  The class provides constructors for initializing colors with double or integer values.
    */
    class PRISM_EXPORT Color {
        public:
            ...
            /**
             * @brief Constructor that initializes the color with specified red, green, and blue values as integers.
